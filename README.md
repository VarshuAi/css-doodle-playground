...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/css-doodle-playground.git
   cd css-doodle-playground
   ```
...
[![Repo](https://img.shields.io/badge/css-doodle-playground-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/css-doodle-playground)
